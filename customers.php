...
<h2 style="margin-top:50px; margin-bottom:-75px; " >Customers</h2>
</div>
...
$sql8 = mysqli_query($connection,"SELECT name,email,mobile FROM booking_info");
...
echo "<tr><td>$print_data8[0]</td><td>$print_data8[1]</td><td>$print_data8[2]</td></tr>";
while ($row = mysqli_fetch_assoc($sql8)) { // Important line !!! Check summary get row on array ..
